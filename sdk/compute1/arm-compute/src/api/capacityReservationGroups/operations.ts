...
import {
  ...
  computeCapacityReservationGroupSerializer,
  computeCapacityReservationGroupDeserializer,
  ComputeCapacityReservationGroupUpdate,
  computeCapacityReservationGroupUpdateSerializer,
  _ComputeCapacityReservationGroupListResult,
  _computeCapacityReservationGroupListResultDeserializer,
...
export async function _listBySubscriptionDeserialize(
...
): Promise<_ComputeCapacityReservationGroupListResult> {
  ...
  return _computeCapacityReservationGroupListResultDeserializer(result.body);
}
...
export function listBySubscription(
  context: Client,
  options: CapacityReservationGroupsListBySubscriptionOptionalParams = { requestOptions: {} },
): PagedAsyncIterableIterator<ComputeCapacityReservationGroup> {
...
export function _updateSend(
  ...
  resourceGroupName: string,
  capacityReservationGroupName: string,
  parameters: ComputeCapacityReservationGroupUpdate,
  ...
  return context
    ...
    .patch({
      ...
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeCapacityReservationGroupUpdateSerializer(parameters),
    });
}

export async function _updateDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeCapacityReservationGroup> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return computeCapacityReservationGroupDeserializer(result.body);
}
...
export function _createOrUpdateSend(
  ...
  resourceGroupName: string,
  capacityReservationGroupName: string,
  parameters: ComputeCapacityReservationGroup,
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeCapacityReservationGroupSerializer(parameters),
    });
}
