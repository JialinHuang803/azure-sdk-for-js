...
import {
  ...
  computeRequestRateByIntervalInputSerializer,
  ComputeLogAnalyticsOperationResult,
  computeLogAnalyticsOperationResultDeserializer,
  ComputeThrottledRequestsInput,
  computeThrottledRequestsInputSerializer,
...
export function _exportThrottledRequestsSend(
  ...
  return context
    ...
    .post({
      ...
      body: computeThrottledRequestsInputSerializer(parameters),
    });
}

export async function _exportThrottledRequestsDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeLogAnalyticsOperationResult> {
  ...
  return computeLogAnalyticsOperationResultDeserializer(result.body);
}
...
export function _exportRequestRateByIntervalSend(
  ...
  return context
    ...
    .post({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeRequestRateByIntervalInputSerializer(parameters),
    });
}
