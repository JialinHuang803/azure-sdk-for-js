...
import {
  ...
  computeDiskDiskUpdateSerializer,
  _ComputeDiskDiskList,
  _computeDiskDiskListDeserializer,
...
export async function _listDeserialize(
  ...
  return _computeDiskDiskListDeserializer(result.body);
}
...
export function _updateSend(
  ...
  return context
    ...
    .patch({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeDiskDiskUpdateSerializer(disk),
    });
}

export async function _updateDeserialize(result: PathUncheckedResponse): Promise<ComputeDiskDisk> {
...
export function _createOrUpdateSend(
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeDiskDiskSerializer(disk),
    });
}
