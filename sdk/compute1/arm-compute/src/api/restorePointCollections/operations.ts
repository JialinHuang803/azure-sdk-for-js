...
import {
  ...
  computeRestorePointCollectionUpdateSerializer,
  _ComputeRestorePointCollectionListResult,
  _computeRestorePointCollectionListResultDeserializer,
...
export async function _listAllDeserialize(
...
): Promise<_ComputeRestorePointCollectionListResult> {
  ...
  return _computeRestorePointCollectionListResultDeserializer(result.body);
}
...
export function _updateSend(
  ...
  return context
    ...
    .patch({
      ...
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeRestorePointCollectionUpdateSerializer(parameters),
    });
}
...
export function _createOrUpdateSend(
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeRestorePointCollectionSerializer(parameters),
    });
}
