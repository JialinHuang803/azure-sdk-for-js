...
import {
  computeVirtualMachineScaleSetVMReimageParametersSerializer,
  ...
  computeVirtualMachineScaleSetVMSerializer,
  computeVirtualMachineScaleSetVMDeserializer,
  ComputeVirtualMachineScaleSetVMInstanceView,
  computeVirtualMachineScaleSetVMInstanceViewDeserializer,
  _ComputeVirtualMachineScaleSetVMListResult,
  _computeVirtualMachineScaleSetVMListResultDeserializer,
...
export async function _getInstanceViewDeserialize(
  ...
  return computeVirtualMachineScaleSetVMInstanceViewDeserializer(result.body);
}
...
export async function _listDeserialize(
  result: PathUncheckedResponse,
): Promise<_ComputeVirtualMachineScaleSetVMListResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return _computeVirtualMachineScaleSetVMListResultDeserializer(result.body);
}
...
export function _updateSend(
  ...
  return context
    ...
    .put({
      ...
      body: computeVirtualMachineScaleSetVMSerializer(parameters),
    });
}
...
export async function _updateDeserialize(
  ...
  return computeVirtualMachineScaleSetVMDeserializer(result.body);
}
...
export function update(
  ...
  return getLongRunningPoller(context, _updateDeserialize, ["200", "202", "201"], {
    ...
    OperationState<ComputeVirtualMachineScaleSetVM>,
    ComputeVirtualMachineScaleSetVM
  >;
}
