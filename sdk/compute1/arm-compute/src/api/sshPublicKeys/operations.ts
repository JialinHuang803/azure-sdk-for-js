...
import {
  ...
  computeSshPublicKeyResourceSerializer,
  computeSshPublicKeyResourceDeserializer,
  ComputeSshPublicKeyUpdateResource,
  computeSshPublicKeyUpdateResourceSerializer,
  _ComputeSshPublicKeysGroupListResult,
  _computeSshPublicKeysGroupListResultDeserializer,
  computeSshGenerateKeyPairInputParametersSerializer,
  ComputeSshPublicKeyGenerateKeyPairResult,
  computeSshPublicKeyGenerateKeyPairResultDeserializer,
...
export function _generateKeyPairSend(
  ...
  options: SshPublicKeysGenerateKeyPairOptionalParams = { requestOptions: {} },
): StreamableMethod {
  ...
  return context
    ...
    .post({
      ...
      body: !options["parameters"]
        ? options["parameters"]
        : computeSshGenerateKeyPairInputParametersSerializer(options["parameters"]),
    });
}
...
export async function _generateKeyPairDeserialize(
  ...
  return computeSshPublicKeyGenerateKeyPairResultDeserializer(result.body);
}
...
export function _listBySubscriptionSend(
  context: Client,
  options: SshPublicKeysListBySubscriptionOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export async function _listBySubscriptionDeserialize(
  result: PathUncheckedResponse,
): Promise<_ComputeSshPublicKeysGroupListResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return _computeSshPublicKeysGroupListResultDeserializer(result.body);
}
...
export function _listByResourceGroupSend(
  context: Client,
  resourceGroupName: string,
  options: SshPublicKeysListByResourceGroupOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _$deleteSend(
  ...
  resourceGroupName: string,
  sshPublicKeyName: string,
  options: SshPublicKeysDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _updateSend(
  ...
  options: SshPublicKeysUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/sshPublicKeys/{sshPublicKeyName}{?api%2Dversion}",
    {
  ...
  return context
    ...
    .patch({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeSshPublicKeyUpdateResourceSerializer(parameters),
    });
}
...
export async function _updateDeserialize(
  ...
  return computeSshPublicKeyResourceDeserializer(result.body);
}
...
export function _createSend(
  ...
  options: SshPublicKeysCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/sshPublicKeys/{sshPublicKeyName}{?api%2Dversion}",
    {
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeSshPublicKeyResourceSerializer(parameters),
    });
}
...
export function _getSend(
  ...
  resourceGroupName: string,
  sshPublicKeyName: string,
  options: SshPublicKeysGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/sshPublicKeys/{sshPublicKeyName}{?api%2Dversion}",
    {
