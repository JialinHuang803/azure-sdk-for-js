...
import {
  ...
  computeVirtualMachineExtensionImageDeserializer,
  computeVirtualMachineExtensionImageArrayDeserializer,
...
export async function _listVersionsDeserialize(
  ...
  return computeVirtualMachineExtensionImageArrayDeserializer(result.body);
}
...
export async function _getDeserialize(
  ...
  return computeVirtualMachineExtensionImageDeserializer(result.body);
}
