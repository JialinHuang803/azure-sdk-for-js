...
import {
  computeVirtualMachineReimageParametersSerializer,
  ComputeVirtualMachine,
  computeVirtualMachineSerializer,
  computeVirtualMachineDeserializer,
  ComputeStorageProfile,
  computeStorageProfileDeserializer,
  ComputeVirtualMachineInstanceView,
  computeVirtualMachineInstanceViewDeserializer,
  ComputeVirtualMachineUpdate,
  computeVirtualMachineUpdateSerializer,
  _ComputeVirtualMachineListResult,
  _computeVirtualMachineListResultDeserializer,
  ComputeVirtualMachineAssessPatchesResult,
  computeVirtualMachineAssessPatchesResultDeserializer,
  ComputeAttachDetachDataDisksRequest,
  computeAttachDetachDataDisksRequestSerializer,
  ComputeVirtualMachineCaptureParameters,
  computeVirtualMachineCaptureParametersSerializer,
  ComputeVirtualMachineCaptureResult,
  computeVirtualMachineCaptureResultDeserializer,
  ComputeVirtualMachineInstallPatchesParameters,
  computeVirtualMachineInstallPatchesParametersSerializer,
  ComputeVirtualMachineInstallPatchesResult,
  computeVirtualMachineInstallPatchesResultDeserializer,
  ComputeRetrieveBootDiagnosticsDataResult,
  computeRetrieveBootDiagnosticsDataResultDeserializer,
  ...
  computeRunCommandInputSerializer,
  ComputeRunCommandResult,
  computeRunCommandResultDeserializer,
  computeMigrateVMToVirtualMachineScaleSetInputSerializer,
...
export async function _listByLocationDeserialize(
...
): Promise<_ComputeVirtualMachineListResult> {
  ...
  return _computeVirtualMachineListResultDeserializer(result.body);
}
  ...
  return context
    ...
    .post({
      ...
      body: !options["parameters"]
        ? options["parameters"]
        : computeMigrateVMToVirtualMachineScaleSetInputSerializer(options["parameters"]),
    });
}
...
export function _runCommandSend(
  ...
  return context
    ...
    .post({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeRunCommandInputSerializer(parameters),
    });
}

export async function _runCommandDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeRunCommandResult> {
  const expectedStatuses = ["202", "200", "201"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return computeRunCommandResultDeserializer(result.body);
}
...
export function runCommand(
  ...
  return getLongRunningPoller(context, _runCommandDeserialize, ["202", "200", "201"], {
    ...
    resourceLocationConfig: "location",
    apiVersion: "2025-04-01",
  }) as PollerLike<OperationState<ComputeRunCommandResult>, ComputeRunCommandResult>;
}
...
export async function _retrieveBootDiagnosticsDataDeserialize(
  ...
  return computeRetrieveBootDiagnosticsDataResultDeserializer(result.body);
}
...
export function _reimageSend(
  ...
  return context
    ...
    .post({
      ...
      body: !options["parameters"]
        ? options["parameters"]
        : computeVirtualMachineReimageParametersSerializer(options["parameters"]),
    });
}
...
export async function _instanceViewDeserialize(
  ...
  return computeVirtualMachineInstanceViewDeserializer(result.body);
}
...
export function _installPatchesSend(
  ...
  return context
    ...
    .post({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeVirtualMachineInstallPatchesParametersSerializer(installPatchesInput),
    });
}

export async function _installPatchesDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeVirtualMachineInstallPatchesResult> {
  const expectedStatuses = ["202", "200", "201"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return computeVirtualMachineInstallPatchesResultDeserializer(result.body);
}
...
export function _captureSend(
  ...
  return context
    ...
    .post({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeVirtualMachineCaptureParametersSerializer(parameters),
    });
}

export async function _captureDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeVirtualMachineCaptureResult> {
  const expectedStatuses = ["202", "200", "201"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return computeVirtualMachineCaptureResultDeserializer(result.body);
}
...
export function _attachDetachDataDisksSend(
  ...
  return context
    ...
    .post({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeAttachDetachDataDisksRequestSerializer(parameters),
    });
}

export async function _attachDetachDataDisksDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeStorageProfile> {
  const expectedStatuses = ["202", "200", "201"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return computeStorageProfileDeserializer(result.body);
}
...
export function attachDetachDataDisks(
  ...
  return getLongRunningPoller(context, _attachDetachDataDisksDeserialize, ["202", "200", "201"], {
    ...
    resourceLocationConfig: "location",
    apiVersion: "2025-04-01",
  }) as PollerLike<OperationState<ComputeStorageProfile>, ComputeStorageProfile>;
}
...
export async function _assessPatchesDeserialize(
  result: PathUncheckedResponse,
): Promise<ComputeVirtualMachineAssessPatchesResult> {
  const expectedStatuses = ["202", "200", "201"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return computeVirtualMachineAssessPatchesResultDeserializer(result.body);
}
...
export function _updateSend(
  ...
  return context
    ...
    .patch({
      ...
      body: computeVirtualMachineUpdateSerializer(parameters),
    });
}
...
export function _createOrUpdateSend(
  ...
  return context
    ...
    .put({
      ...
      body: computeVirtualMachineSerializer(parameters),
    });
}
