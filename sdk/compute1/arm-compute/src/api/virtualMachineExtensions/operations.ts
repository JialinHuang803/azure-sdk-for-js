...
import {
  ...
  computeVirtualMachineExtensionSerializer,
  computeVirtualMachineExtensionDeserializer,
  ComputeVirtualMachineExtensionUpdate,
  computeVirtualMachineExtensionUpdateSerializer,
  ComputeVirtualMachineExtensionsListResult,
  computeVirtualMachineExtensionsListResultDeserializer,
...
export async function _listDeserialize(
  ...
  return computeVirtualMachineExtensionsListResultDeserializer(result.body);
}
...
export function _updateSend(
  ...
  return context
    ...
    .patch({
      ...
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeVirtualMachineExtensionUpdateSerializer(extensionParameters),
    });
}
...
export async function _updateDeserialize(
  ...
  return computeVirtualMachineExtensionDeserializer(result.body);
}
...
export function update(
  ...
  return getLongRunningPoller(context, _updateDeserialize, ["200", "201", "202"], {
    ...
    resourceLocationConfig: "location",
    apiVersion: "2025-04-01",
  }) as PollerLike<OperationState<ComputeVirtualMachineExtension>, ComputeVirtualMachineExtension>;
}
...
export function _createOrUpdateSend(
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeVirtualMachineExtensionSerializer(extensionParameters),
    });
}
