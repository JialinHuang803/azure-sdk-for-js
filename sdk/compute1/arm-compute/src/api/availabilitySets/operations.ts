...
import {
  ...
  computeAvailabilitySetSerializer,
  computeAvailabilitySetDeserializer,
  ComputeAvailabilitySetUpdate,
  computeAvailabilitySetUpdateSerializer,
  _ComputeAvailabilitySetListResult,
  _computeAvailabilitySetListResultDeserializer,
  ComputeMigrateToVirtualMachineScaleSetInput,
  computeMigrateToVirtualMachineScaleSetInputSerializer,
  computeConvertToVirtualMachineScaleSetInputSerializer,
  ...
  return context
    ...
    .post({
      ...
      body: !options["parameters"]
        ? options["parameters"]
        : computeConvertToVirtualMachineScaleSetInputSerializer(options["parameters"]),
    });
}
...
export function _validateMigrationToVirtualMachineScaleSetSend(
  ...
  return context
    ...
    .post({
      ...operationOptionsToRequestParameters(options),
      contentType: "application/json",
      body: computeMigrateToVirtualMachineScaleSetInputSerializer(parameters),
    });
}
...
export async function _listBySubscriptionDeserialize(
  result: PathUncheckedResponse,
): Promise<_ComputeAvailabilitySetListResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = commonCloudErrorDeserializer(result.body);
  ...
  return _computeAvailabilitySetListResultDeserializer(result.body);
}
...
export function _updateSend(
  ...
  return context
    ...
    .patch({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeAvailabilitySetUpdateSerializer(parameters),
    });
}
...
export async function _updateDeserialize(
  ...
  return computeAvailabilitySetDeserializer(result.body);
}
...
export function _createOrUpdateSend(
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: computeAvailabilitySetSerializer(parameters),
    });
}
